...
<a href="https://tastewp.com/new?pre-installed-plugin-slug=wp-image-refresh&redirect=admin.php?page=wp_image_refresh&ni=true" target="_blank">https://tastewp.com/new?pre-installed-plugin-slug=wp-image-refresh</a>
...
== Changelog ==
= 2.3 =
* Fixed security issues and tested with 6.2.2 version

= 2.2 =
* Fixed security issue

= 2.1 =
* Tested with compatibility upto WordPress version 5.8.2

= 2.0 =
* Tested with compatibility upto WordPress version 5.8.1
